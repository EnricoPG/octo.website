  ...
  return (
    <main>
      ...
      <section id="manifiesto" className="manifesto shell section-line numbered">
        ...
        <Reveal delay={40}><h2>Construimos <em>ecosistemas</em><br/>digitales que hacen<br/>crecer tu negocio.</h2></Reveal>
        <Reveal delay={130}><p>Conectamos estrategia, diseño, desarrollo, automatización e inteligencia artificial para crear ecosistemas digitales que optimizan procesos, generan oportunidades y aceleran el crecimiento de tu empresa.</p></Reveal>
